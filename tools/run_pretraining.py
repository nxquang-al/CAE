...
def get_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="dall-e",
        help="[dall-e, vqgan_gumbel_f8_8192, customized]",
    )
    ...
    parser.add_argument(
        "--exp_name", default="", type=str, help="it is used when save the checkpoint"
    )
    parser.add_argument(
        "--enable_multi_print",
        action="store_true",
        default=False,
        help="allow each gpu to print something",
    )
    ...
    """
    parser.add_argument(
        "--mask_generator", default="block", type=str, help="block or random"
    )
    ...
    parser.add_argument(
        "--ratio_mask_patches", default=None, type=float, help="mask ratio"
    )
    ...
    parser.add_argument(
        "--decoder_num_heads", default=12, type=int, help="Number of heads for decoder"
    )
    parser.add_argument(
        "--decoder_num_classes",
        default=8192,
